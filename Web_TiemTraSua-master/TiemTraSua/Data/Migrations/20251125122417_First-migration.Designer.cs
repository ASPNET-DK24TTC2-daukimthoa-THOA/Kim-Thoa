...
namespace TiemTraSua.Migrations
{
    ...
    [Migration("20251125122417_First-migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbChiTietHoaDonBan", b =>
            {
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbHoaDonBan", b =>
            {
                b.Property<Guid>("MaHoaDon")
                    .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbKhachHang", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbNhomSanPham", b =>
            {
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbPhanHoi", b =>
            {
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbQuanTriVien", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbSanPham", b =>
            {
                b.Property<int>("MaSanPham")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbTinTuc", b =>
            {
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbChiTietHoaDonBan", b =>
            {
                b.HasOne("TiemTraSua.Models.TbHoaDonBan", "MaHoaDonNavigation")
                    .WithMany("TbChiTietHoaDonBans")
                    .HasForeignKey("MaHoaDon")
                    .IsRequired()
                    .HasConstraintName("FK__tbChiTiet__MaHoa__440B1D61");

                b.HasOne("TiemTraSua.Models.TbSanPham", "MaSanPhamNavigation")
                    .WithMany("TbChiTietHoaDonBans")
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbHoaDonBan", b =>
            {
                b.HasOne("TiemTraSua.Models.TbKhachHang", "Customer")
            ...
            modelBuilder.Entity("TiemTraSua.Models.TbSanPham", b =>
            {
                b.HasOne("TiemTraSua.Models.TbNhomSanPham", "MaNhomSpNavigation")
                    .WithMany("TbSanPhams")
